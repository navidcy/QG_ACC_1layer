...
[nlin0_z,nlin0_U] = DtUzeta_ETDRK4(zhat,U);
k1z = eL2.*zhat + Q.*nlin0_z;   k1U = nlin0_U;

[nlin1_z,nlin1_U] = DtUzeta_ETDRK4(k1z,U+k1U*dt/2);
k2z = eL2.*zhat + Q.*nlin1_z;   k2U = nlin1_U;

[nlin2_z,nlin2_U] = DtUzeta_ETDRK4(k2z,U+k2U*dt/2);
k3z = eL2.*k1z + Q.*(2*nlin2_z-nlin0_z);   k3U = nlin2_U;

[nlin3_z,nlin3_U] = DtUzeta_ETDRK4(k3z,U+k3U*dt);
                                   k4U = nlin3_U;
